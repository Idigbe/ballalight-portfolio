      ...
      <div className="grid grid-cols-12 my-1 px-0 md:px-0">
        <div className="grid col-span-12 justify-items-center px-0 md:px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"/assets/work/projects/bk-payment/bk-deposit-landing.jpg"}
            alt="BetKing: Payments"
          />
        </div>
        {/* Start ==================================================================*/}
            ...
            <div className='grid grid-cols-8 md:my-4 md:px-2'>
              <div className="grid col-span-12 ">
                <MotionImage
                  ...
                  xWidth="400"
                  xHeight="auto"
                  imageSrc={"/assets/utility/bk-mob-util.png"}
                  alt="Trade Trackers"
                />
              </div>
              {/* Div */}
          ...
          <div className="grid grid-cols-12 my-1 px-0 md:px-2">
            ...
            <div className="grid col-span-12 md:col-span-6 justify-items-left px-0 md:px-2 my-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"/assets/work/projects/bk-payment/target.png"}
                alt="BetKing: Payments"
              />
            </div>
            {/* Row */}
            ...
            <div className="grid  col-span-12 md:col-span-6 px-0  my-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"/assets/work/projects/bk-payment/user-survey.png"}
                alt="BetKing: Payments"
              />
            </div>
            <div className="grid col-span-12 md:col-span-6 justify-items-left px-0 md:px-2 my-2">
            ...
            <div className="grid col-span-12 md:col-span-6  justify-items-left px-0 md:px-2 my-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"/assets/work/projects/bk-payment/paystack.png"}
                alt="BetKing: Payments"
              />
            </div>
            ...
            <div className="grid col-span-12 md:col-span-6 justify-items-left px-0 md:px-2 my-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"/assets/work/projects/bk-payment/cs.png"}
                alt="BetKing: Payments"
              />
            </div>
            ...
            <div className="grid col-span-12 md:col-span-6 px-0 md:px-2 ">
              <div className="max-w-[75%] md:max-w-[50%]">
                <MotionImage
                  ...
                  xWidth="auto"
                  xHeight="auto"
                  imageSrc={"/assets/work/projects/bk-payment/risk.png"}
                  alt="BetKing: Payments"
                />
              </div>
            ...
            <div className="grid col-span-12 md:col-span-6 px-0 md:px-2">
              <div className="max-w-[75%] md:max-w-[50%]">
                <MotionImage
                  ...
                  xWidth="auto"
                  xHeight="auto"
                  imageSrc={"/assets/work/projects/bk-payment/chunking.png"}
                  alt="BetKing: Payments"
                />
              </div>
              <div className="flex flex-row  w-[90%]  my-4  md:pr-16">
            ...
            <div className="grid col-span-12 md:col-span-6 px-0 md:px-2">
              <div className="max-w-[75%] md:max-w-[50%]">
                <MotionImage
                  ...
                  xWidth="auto"
                  xHeight="auto"
                  imageSrc={"/assets/work/projects/bk-payment/default-effect.png"}
                  alt="BetKing: Payments"
                />
              </div>
            ...
            <div className="grid col-span-12 md:col-span-6 px-0 md:px-2">
              <div className="max-w-[75%] md:max-w-[50%]">
                <MotionImage
                  ...
                  xWidth="auto"
                  xHeight="auto"
                  imageSrc={"/assets/work/projects/bk-payment/feedback-loops.png"}
                  alt="BetKing: Payments"
                />
              </div>
              <div className="flex flex-row  w-[90%] my-4  md:pr-16 ">
            ...
            {/* Div Mobile =========================================================== */}
            <Designs url="/assets/work/projects/bk-payment/dep-card-1.png" />
            <Designs url="/assets/work/projects/bk-payment/dep-card-2.png" />
            <Designs url="/assets/work/projects/bk-payment/dep-card-3.png" />
            <Designs url="/assets/work/projects/bk-payment/dep-card-4.png" />
            <Designs url="/assets/work/projects/bk-payment/dep-card-5.png" />
            <Designs url="/assets/work/projects/bk-payment/dep-card-6.png" />
            <Designs url="/assets/work/projects/bk-payment/dep-card-7.png" />
            <Designs url="/assets/work/projects/bk-payment/dep-card-8.png" />
            <Designs url="/assets/work/projects/bk-payment/dep-card-10.png" />
            <Designs url="/assets/work/projects/bk-payment/dep-card-9.png" />

          </div>
          {/*  =========================================================== */}
          <div className="flex flex-row  justify-items-center md:my-4 px-0">
            <DesignsMd url="/assets/work/projects/bk-payment/dep-card-1.png" />
            <DesignsMd url="/assets/work/projects/bk-payment/dep-card-2.png" />
            <DesignsMd url="/assets/work/projects/bk-payment/dep-card-3.png" />
            <DesignsMd url="/assets/work/projects/bk-payment/dep-card-4.png" />
            <DesignsMd url="/assets/work/projects/bk-payment/dep-card-5.png" />

          </div>
          {/*  =========================================================== */}
          <div className="flex flex-row  justify-items-center md:my-4 md:px-0">
            <DesignsMd url="/assets/work/projects/bk-payment/dep-card-6.png" />
            <DesignsMd url="/assets/work/projects/bk-payment/dep-card-7.png" />
            <DesignsMd url="/assets/work/projects/bk-payment/dep-card-8.png" />
            <DesignsMd url="/assets/work/projects/bk-payment/dep-card-10.png" />
            <DesignsMd url="/assets/work/projects/bk-payment/dep-card-9.png" />
          </div>
          {/*  =========================================================== */}
          {/* Row */}
          <div className="grid grid-cols-12 my-1 px-0 md:px-2">
            ...
            <div className="grid col-span-12 justify-items-center px-0 my-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"/assets/work/projects/bk-payment/before-meets-after.png"}
                alt="BetKing: Payments"
              />
            </div>
            {/* Row */}
            ...
            <div className="grid col-span-12 md:col-span-6  justify-items-center px-2 my-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"/assets/work/projects/bk-payment/target2.png"}
                alt="BetKing: Payments"
              />
            </div>
            {/* Bottom Nav */}
