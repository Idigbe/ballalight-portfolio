      ...
      <div className="grid grid-cols-12 my-1 px-0 md:px-2">
        ...
        <div className="grid col-span-12 justify-items-center px-0 md:px-2 my-2">
          <MotionImage
            ...
            xWidth="800"
            xHeight="auto"
            imageSrc={"/assets/work/projects/ub/1.png"}
            alt="Union Bank"
          />
        </div>
            ...
            <div className="grid grid-cols-8 md:my-4 md:px-2">
              <div className="grid col-span-12 ">
                <MotionImage
                  ...
                  xWidth="500"
                  xHeight="auto"
                  imageSrc={"/assets/utility/ub-util.png"}
                  alt="Union Bank"
                />
              </div>
              {/* Div */}
          ...
          <div className="grid grid-cols-12 my-1 px-0 md:px-2">
            ...
            <div className="grid col-span-12 justify-items-center px-0 md:px-2 my-2">
              <MotionImage
                ...
                xWidth="800"
                xHeight="auto"
                imageSrc={"/assets/work/projects/ub/2.png"}
                alt="Union Bank"
              />
            </div>
            <div className="grid col-span-12  px-0 md:px-2">
            ...
            <div className="grid col-span-12 justify-items-left px-0 md:px-2 my-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"/assets/work/projects/ub/3.png"}
                alt="Union Bank"
              />
            </div>
            <div className='grid col-span-12  justify-items-left px-0 md:px-2 my-2'>
            ...
            <div className="grid col-span-12 md:col-span-6 justify-items-left px-0 md:px-2 my-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"/assets/work/projects/ub/4.png"}
                alt="Union Bank"
              />
            </div>
            <div className='grid col-span-12 md:col-span-6 justify-items-left px-0 md:px-2 my-2'>
            ...
            <div className="grid col-span-12 md:col-span-6 justify-items-left px-0 md:px-2 my-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"/assets/work/projects/ub/5.png"}
                alt="Union Bank"
              />
            </div>
            {/* Row */}
            ...
            <div className="grid col-span-12 md:col-span-6 justify-items-left px-0 md:px-2 my-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"/assets/work/projects/ub/6.png"}
                alt="Union Bank"
              />
            </div>
            {/* Row */}
            ...
            <div className="grid col-span-12 justify-items-start px-0 md:px-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"/assets/work/projects/ub/7.png"}
                alt="Union Bank"
              />
            </div>
            <div className="grid col-span-12  px-0 md:px-2">
            ...
            {/* Div */}
            <Designs url="/assets/work/projects/ub/b-1.png" />
            <Designs url="/assets/work/projects/ub/b-2.png" />
            <Designs url="/assets/work/projects/ub/b-3.png" />
            <Designs url="/assets/work/projects/ub/b-4.png" />
            <Designs url="/assets/work/projects/ub/b-5.png" />
            <Designs url="/assets/work/projects/ub/b-6.png" />
            <Designs url="/assets/work/projects/ub/b-7.png" />
            <Designs url="/assets/work/projects/ub/b-8.png" />
            <Designs url="/assets/work/projects/ub/b-9.png" />
            <Designs url="/assets/work/projects/ub/b-10.png" />
            <Designs url="/assets/work/projects/ub/b-11.png" />
            <Designs url="/assets/work/projects/ub/b-12.png" />
          </div>
        </>
      }
      {
