...
const Showcase = ({ url, width, height }: { url: string, width: string, height: string }) => {
  const [ref, inView] = useInView();
  return (
    <div className="grid col-span-12 md:col-span-4 justify-items-center p-2 my-2 md:my-0  md:p-2 md:mx-2 bg-blue-gray-50 rounded-3xl " >
      <motion.div
        ref={ref}
  ...
  return (
    <article className="pr-2 md:pr-0">
        ...
        <div className="grid md:col-span-5">
          <div className="flex flex-col md:pt-10">
            ...
            <p className='font-normal text-base md:text-xl my-3  md:px-1'>
              I am a Product Designer based in <span className='font-thin text-gray-300 line-through'>Lagos, Dubai </span>London, with over 6 years of expertise in creating innovative user-centered & data-driven designs for both Mobile and Web.
            </p>
          ...
          <div className="flex flex-col items-end justify-items-right">
            ...
            >
              <video autoPlay loop muted className="w-[auto] h-[auto] object-cover rounded-3xl">
                <source
                  src={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/home/vid-1.mp4"}
                  type="video/mp4"
                  width={0}
                  height={0}
                />
        ...
        >
          <div className="flex flex-col items-center my-2">
            <video autoPlay loop muted className="w-[auto] h-[auto] object-cover">
              <source src={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/home/web-portfolio.mp4"} type="video/mp4" />
              Your browser does not support the video tag.
            </video>
          </div>
        </motion.div>
      ...
      <section className="flex flex-col items-center justify-items-center p-0 my-2 md:hidden ">
        ...
        >
          <video autoPlay loop muted className="w-[auto] h-[auto]  object-cover rounded-xl">
            <source src={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/home/vid-1.mp4"} type="video/mp4" />
            Your browser does not support the video tag.
          </video>
        </motion.div>
      </section>
      ...
      <section className="grid grid-cols-12 my-1 ">
        <Showcase
          url={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/home/bt-1.mp4"}
          // width={"380px"}
          // height={"620px"}
          width={"100%"}
          height={"100%"}
        />
        <Showcase
          url={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/home/bt-2.mp4"}
          width={"100%"}
          height={"100%"}
        />
        <Showcase
          url={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/home/bt-3.mp4"}
          width={"100%"}
          height={"100%"}
        />
      </section>
      ...
      <section className="flex flex-col  md:items-start my-6 px-0 md:px-1">
        ...
        <Link href="https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/my-portfolio.pdf" target='_blank' className="btn-primary md:btn-primary-md  my-4 md:my-4">
          Download CV&nbsp;
          <i className="fas fa-arrow-right" />
        </Link>
      </section>
