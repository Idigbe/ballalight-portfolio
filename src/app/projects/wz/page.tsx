      ...
      <div className="grid grid-cols-12 my-1 px-2">
        ...
        <div className="grid col-span-12 justify-items-center px-0 md:px-2 my-2">
          <MotionImage
            ...
            xWidth="800"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/woozeee-ecom/1.png"}
            alt="woozeee"
          />
        </div>
            ...
            <div className="grid grid-cols-8 md:my-4 md:px-2">
              <div className="grid col-span-12 ">
                <MotionImage
                  ...
                  xWidth="400"
                  xHeight="auto"
                  imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/utility/wz-util.png"}
                  alt="woozeee"
                />
              </div>
              {/* Div */}
        ...
        <div className="grid col-span-12 md:col-span-6 justify-items-center px-2 my-4">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/woozeee-ecom/2.png"}
            alt="woozeee"
          />
        </div>
        <div className="grid col-span-12 md:col-span-6 justify-items-center  px-2  my-4">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/woozeee-ecom/3.png"}
            alt="woozeee"
          />
        </div>
        {/* Row */}
        ...
        <div className="grid col-span-6  md:col-span-3 justify-items-center  px-2  my-6">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/woozeee-ecom/4.png"}
            alt="woozeee"
          />
        </div>
        <div className="grid col-span-6 md:col-span-3 justify-items-center  px-2  my-6">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/woozeee-ecom/5.png"}
            alt="woozeee"
          />
        </div>
        <div className="grid col-span-6 md:col-span-3 justify-items-center  px-2  my-6">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/woozeee-ecom/6.png"}
            alt="woozeee"
          />
        </div>
        <div className="grid col-span-6 md:col-span-3 justify-items-center  px-2  my-6">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/woozeee-ecom/7.png"}
            alt="woozeee"
          />
        </div>
        ...
        <div className="grid col-span-12 md:col-span-6  justify-items-center  px-2 my-6">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/woozeee-ecom/8.png"}
            alt="woozeee"
          />
        </div>
        <div className="grid col-span-12 md:col-span-6  justify-items-center  px-2 my-6">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/woozeee-ecom/9.png"}
            alt="woozeee"
          />
        </div>
      </div>
