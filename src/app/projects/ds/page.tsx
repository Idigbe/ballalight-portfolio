      ...
      <div className="grid grid-cols-12 my-1">
        ...
        <div className="grid col-span-12 justify-items-center px-4 md:px-12 my-2">
          <MotionImage
            ...
            xWidth="800"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/1.png"}
            alt="Design System"
          />
        </div>
            ...
            <div className="grid grid-cols-8 md:my-4 md:px-2">
              <div className="grid col-span-12 ">
                <MotionImage
                  ...
                  xWidth="70"
                  xHeight="auto"
                  imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/utility/figma.png"}
                  alt="Design System"
                />
              </div>
              {/* Div */}
        ...
        <div className="grid col-span-12 px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/2.png"}
            alt="Design System"
          />
        </div>
        <div className="grid col-span-12 px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/3.png"}
            alt="Design System"
          />
        </div>
        <div className="grid col-span-12 px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/4.png"}
            alt="Design System"
          />
        </div>
        {/* Row */}
        <div className="grid col-span-6 justify-items-center px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/5.png"}
            alt="Design System"
          />
        </div>
        <div className="grid col-span-6 justify-items-center px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/6.png"}
            alt="Design System"
          />
        </div>
        {/* Row */}
        <div className="grid col-span-6 justify-items-center px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/7.png"}
            alt="Design System"
          />
        </div>
        <div className="grid col-span-6 justify-items-center px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/8.png"}
            alt="Design System"
          />
        </div>
        {/* Row */}
        ...
        <div className="grid col-span-12 justify-items-left px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/9.png"}
            alt="Design System"
          />
        </div>
        {/* Row */}
        <div className="grid col-span-12 justify-items-left px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/10.png"}
            alt="Design System"
          />
        </div>
        {/* Row */}
        <div className="grid col-span-12 justify-items-left px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/11.png"}
            alt="Design System"
          />
        </div>
        {/* Row */}
        <div className="grid col-span-12 justify-items-left px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/12.png"}
            alt="Design System"
          />
        </div>
        {/* Row */}
        <div className="grid col-span-12 justify-items-left px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/13.png"}
            alt="Design System"
          />
        </div>
        {/* Row */}
        <div className="grid col-span-12 justify-items-left px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/14.png"}
            alt="Design System"
          />
        </div>
        {/* Row */}
        <div className="grid col-span-12 justify-items-left px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/15.png"}
            alt="Design System"
          />
        </div>
        {/* Row */}
        <div className="grid col-span-12 justify-items-left px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/16.png"}
            alt="Design System"
          />
        </div>
        {/* Row */}
        <div className="grid col-span-12 justify-items-left px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/17.png"}
            alt="Design System"
          />
        </div>
        {/* Row */}
        <div className="grid col-span-12 justify-items-left px-0 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/ds/18.png"}
            alt="Design System"
          />
        </div>
