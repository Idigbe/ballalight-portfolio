      ...
      <div className="grid grid-cols-12 my-1 px-0 md:px-2">
        ...
        <div className="grid col-span-12 justify-items-center px-2 my-2">
          <MotionImage
            ...
            xWidth="auto"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/trade-tracker/tt.png"}
            alt="Trade Trackers"
          />
        </div>
            ...
            <div className="grid grid-cols-8 md:my-4 md:px-2">
              <div className="grid col-span-12 ">
                <MotionImage
                  ...
                  xWidth="400"
                  xHeight="auto"
                  imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/utility/tt-util.png"}
                  alt="Trade Trackers"
                />
              </div>
              {/* Div */}
          ...
          <div className="grid grid-cols-12 my-1 px-0 md:px-2">
            ...
            <div className="grid col-span-12 md:col-span-6 justify-items-center px-0 md:px-2 my-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/trade-tracker/tt-3.png"}
                alt="Trade Trackers"
              />
            </div>
            ...
            <div className="grid col-span-12 md:col-span-6 justify-items-center px-0 md:px-2 my-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/trade-tracker/tt-4.png"}
                alt="Trade Trackers"
              />
            </div>
            {/* Row */}
            ...
            <div className="grid col-span-12 md:col-span-6 justify-items-left px-0 md:px-2 my-2 md:pr-16">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/trade-tracker/slack.png"}
                alt="Trade Trackers"
              />
            ...
            <div className="grid col-span-12 md:col-span-6 justify-items-left px-0 md:px-2 my-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/trade-tracker/stripe.png"}
                alt="Trade Trackers"
              />
              <article className='project-text md:project-text-md  my-5'>
                Reason for Choice:
            ...
            <div className="grid col-span-12 md:col-span-6 justify-items-left px-0 md:px-2 my-2 md:pr-16">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/trade-tracker/notion.png"}
                alt="Trade Trackers"
              />
              <article className='project-text md:project-text-md  my-5'>
                Reason for Choice:
            ...
            <div className="grid col-span-12 md:col-span-6 justify-items-left px-0 md:px-2 my-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/trade-tracker/duolingo.png"}
                alt="Trade Trackers"
              />
              <article className='project-text md:project-text-md  my-5'>
                Reason for Choice:
            ...
            <div className="grid col-span-12 md:col-span-6 justify-items-left px-0 md:px-2 my-2 md:pr-16">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/trade-tracker/salesforce.png"}
                alt="Trade Trackers"
              />
              <article className='project-text md:project-text-md  my-5'>
                Reason for Choice:
            ...
            <div className="grid col-span-12 md:col-span-6 justify-items-start px-0 md:px-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/trade-tracker/ux-persona-1.png"}
                alt="Trade Trackers"
              />
            </div>
            <div className="grid col-span-12 md:col-span-6 justify-items-start px-0 md:px-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/trade-tracker/ux-persona-2.png"}
                alt="Trade Trackers"
              />
            </div>
            {/* Row */}
            ...
            <div className="grid col-span-12 justify-items-start px-0 md:px-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/trade-tracker/as-tt.png"}
                alt="Trade Trackers"
              />
            </div>
            {/* Row */}
            ...
            <div className="grid col-span-12 md:col-span-6 justify-items-start px-0 md:px-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/trade-tracker/dash-light.png"}
                alt="Trade Trackers"
              />
            </div>
            <div className="grid col-span-12 md:col-span-6 justify-items-start px-0 md:px-2">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/trade-tracker/dash-dark.png"}
                alt="Trade Trackers"
              />
            </div>
            <div className="grid col-span-12  px-0 md:px-2">
