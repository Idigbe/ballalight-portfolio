      ...
      <div className="grid grid-cols-12 my-1 px-2">
        ...
        <div className="grid col-span-12 justify-items-center px-2 my-2">
          <MotionImage
            ...
            xWidth="800"
            xHeight="auto"
            imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/six-street/1.png"}
            alt="Six Street"
          />
        </div>
            ...
            <div className="grid grid-cols-8 md:my-4 md:px-2">
              <div className="grid col-span-12 ">
                <MotionImage
                  ...
                  xWidth="400"
                  xHeight="auto"
                  imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/utility/ss-util.png"}
                  alt="Six Street"
                />
              </div>
              {/* Div */}
          ...
          <div className="grid grid-cols-12 my-1 px-2">
            ...
            <div className="grid col-span-12 justify-items-center px-2 my-4">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/six-street/2.png"}
                alt="Six Street"
              />
            </div>
            ...
            <div className="grid col-span-12 justify-items-center px-2 my-4">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/six-street/3.png"}
                alt="Six Street"
              />
            </div>
            <div className="grid col-span-12 md:col-span-6 justify-items-left px-2 my-2 md:pr-16">
            ...
            <div className="grid col-span-12 justify-items-center px-2 my-4">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/six-street/4.png"}
                alt="Six Street"
              />
            </div>
            <div className="grid col-span-12 md:col-span-6 justify-items-left px-2 my-2 md:pr-16">
            ...
            <div className="grid col-span-12 justify-items-center px-2 my-4">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/six-street/5.png"}
                alt="Six Street"
              />
            </div>
            <div className="grid col-span-12 md:col-span-6 justify-items-left px-2 my-2 md:pr-16">
            ...
            <div className="grid col-span-12 justify-items-center px-2 my-4">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/six-street/6.png"}
                alt="Six Street"
              />
            </div>
            ...
            <div className="grid col-span-12 justify-items-center px-2 my-4">
              <MotionImage
                ...
                xWidth="auto"
                xHeight="auto"
                imageSrc={"https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/six-street/7.png"}
                alt="Six Street"
              />
            </div>
            <div className="grid col-span-12 justify-items-left px-2 my-2">
            ...
            {/* Row */}
            <Designs url="https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/six-street/8.png" />
            <Designs url="https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/six-street/9.png" />
            <Designs url="https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/six-street/10.png" />
            <Designs url="https://breakoutng-assets.s3.eu-west-2.amazonaws.com/ld/portfolio-files/nd/assets/work/projects/six-street/11.png" />
          </div>
        </>
      }
      {
